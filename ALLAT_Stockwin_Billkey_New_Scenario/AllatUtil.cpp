...
#define	PARAINI		".\\AllatPay_para.ini"
...
int CertRegReq(ALLAT_DATA sAt_data, const char *sSsl_flag, ALLAT_DATA sRetTxt){
	...
	char szALLAT_ADDR[512 + 1] = { 0x00, };
	char szALLAT_HOST[512 + 1] = { 0x00, };
	char szCERTREQ_URI[512 + 1] = { 0x00, };

	GetPrivateProfileString("ALLAT_PAYMEMT", "ALLAT_ADDR", ALLAT_ADDR, (char *)szALLAT_ADDR, sizeof(szALLAT_ADDR), PARAINI);
	GetPrivateProfileString("ALLAT_PAYMEMT", "ALLAT_HOST", ALLAT_HOST, (char *)szALLAT_HOST, sizeof(szALLAT_HOST), PARAINI);
	GetPrivateProfileString("ALLAT_PAYMEMT", "CERTREQ_URI ", CERTREQ_URI, (char *)szCERTREQ_URI, sizeof(szCERTREQ_URI), PARAINI);

	if (strcmp(sSsl_flag, "SSL") == 0){
		nRet = SendRepo(sAt_data, ALLAT_ADDR, szCERTREQ_URI, ALLAT_HOST, 443, sRetTxt);
		if (nRet != 0){
			return nRet;
		}
	}
		...
		nChkEnc = _check_enc(sAt_data);
		if (nChkEnc == 0){      /** 암호화 됨 **/
			nRet = SendRepo(sAt_data, ALLAT_ADDR, szCERTREQ_URI, ALLAT_HOST, 80, sRetTxt);
			if (nRet != 0){
				return nRet;
			}
		}
...
int CertCancelReq(ALLAT_DATA sAt_data, const char *sSsl_flag, ALLAT_DATA sRetTxt){
	...
	char szALLAT_ADDR[512 + 1] = { 0x00, };
	char szALLAT_HOST[512 + 1] = { 0x00, };
	char szCERTCANCEL_URI[512 + 1] = { 0x00, };

	GetPrivateProfileString("ALLAT_PAYMEMT", "ALLAT_ADDR", ALLAT_ADDR, (char *)szALLAT_ADDR, sizeof(szALLAT_ADDR), PARAINI);
	GetPrivateProfileString("ALLAT_PAYMEMT", "ALLAT_HOST", ALLAT_HOST, (char *)szALLAT_HOST, sizeof(szALLAT_HOST), PARAINI);
	GetPrivateProfileString("ALLAT_PAYMEMT", "CERTREQ_URI ", CERTCANCEL_URI, (char *)szCERTCANCEL_URI, sizeof(szCERTCANCEL_URI), PARAINI);


	if (strcmp(sSsl_flag, "SSL") == 0){
		nRet = SendRepo(sAt_data, ALLAT_ADDR, szCERTCANCEL_URI, ALLAT_HOST, 443, sRetTxt);
		if (nRet != 0){
			return nRet;
		}
	}
		...
		nChkEnc = _check_enc(sAt_data);
		if (nChkEnc == 0){      /** 암호화 됨 **/
			nRet = SendRepo(sAt_data, ALLAT_ADDR, szCERTCANCEL_URI, ALLAT_HOST, 80, sRetTxt);
			if (nRet != 0){
				return nRet;
			}
		}
